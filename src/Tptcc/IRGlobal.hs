...
renderSymbol (name, symbol) =
  "SYMBOL\t"
    ...
    <> "\t"
    <> maybe "" (Text.unpack . placeKindCode . placeKind) (irSymbolPlace symbol)
    <> "\t"
...
normalizePlaceValue place
  | placeKind place == VirtualRegister = "vr"
